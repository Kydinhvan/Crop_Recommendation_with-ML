...
def predictOutput(provNumber, maxTemp, minTemp, avgTemp, humRel, avgRain, sunDur, maxWind, avgWind, 
                  maxTemp_min, maxTemp_max, minTemp_min, minTemp_max, 
                  avgTemp_min, avgTemp_max, humRel_min, humRel_max, 
                  avgRain_min, avgRain_max, sunDur_min, sunDur_max, 
                  maxWind_min, maxWind_max, avgWind_min, avgWind_max):
